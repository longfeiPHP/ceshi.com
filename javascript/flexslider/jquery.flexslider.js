! function (e) {//e:function (a,b){return new p.fn.init(a,b,c)}
    e.flexslider = function (t, i) {//t:html元素 i:param
        var n = e(t),//flexslider div对象
            a = e.extend({}, e.flexslider.defaults, i),//配置参数
            o = a.namespace,//命名空间
            s = "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch,
            r = s ? "touchend" : "click",//touchend
            l = a.direction === "vertical",//false
            c = a.reverse,//false
            u = a.itemWidth > 0,//false
            d = a.animation === "fade",//true
            f = a.asNavFor !== "",//false
            p = {};//空对象
        e.data(t, "flexslider", n);
        p = {
            init: function () {
                n.animating = false;//flexslider div对象的animating属性
                n.currentSlide = a.startAt;//配置项里面为0
                n.animatingTo = n.currentSlide;//0
                n.atEnd = n.currentSlide === 0 || n.currentSlide === n.last;//true
                n.containerSelector = a.selector.substr(0, a.selector.search(" "));//.slides   ul
                n.slides = e(a.selector, n);//li
                n.container = e(n.containerSelector, n);//ul
                n.count = n.slides.length;//li 个数
                n.syncExists = e(a.sync).length > 0;//false
                if (a.animation === "slide") a.animation = "swing";//重定义配置项
                n.prop = l ? "top" : "marginLeft";//marginLeft
                n.args = {};//空对象
                n.manualPause = false;
                n.transitions = !a.video && !d && a.useCSS && function () {
                    var e = document.createElement("div"),
                        t = ["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective",
                                "msPerspective"];
                    for (var i in t) {
                ...
                if (a.controlsContainer !== "") n.controlsContainer = e(a.controlsContainer).length > 0 && e(a.controlsContainer);//false
                if (a.manualControls !== "") n.manualControls = e(a.manualControls).length > 0 && e(a.manualControls);//false
                if (a.randomize) {//false
                ...
                n.doMath();
                if (f) p.asNav.setup();//false
                n.setup("init");
                if (a.controlNav) p.controlNav.setup();//true
                if (a.directionNav) p.directionNav.setup();//true
                if (a.keyboard && (e(n.containerSelector).length === 1 || a.multipleKeyboard)) {//true&&(true||false) 一个.slides   ul的时候可以用左右键切换
                    e(document).bind("keyup", function (e) {//绑定键盘事件
                        var t = e.keyCode;//键盘码
                        if (!n.animating && (t === 39 || t === 37)) {//左右键
                            var i = t === 39 ? n.getTarget("next") : t === 37 ? n.getTarget("prev") : false;//当前序列
                            n.flexAnimate(i, a.pauseOnAction)//显示当前序列的图片
                        }
                    })
                }
                if (a.mousewheel) {//鼠标滚轮
            ...
            controlNav: {
                ...
                setupPaging: function () {
                    var t = a.controlNav === "thumbnails" ? "control-thumbs" : "control-paging",
                        i = 1,
                        l;
                    n.controlNavScaffold = e('<ol class="' + o + "control-nav " + o + t + '" style="z-index:10;"></ol>');
                    if (n.pagingCount > 1) {
                        for (var c = 0; c < n.pagingCount; c++) {
                            l = a.controlNav === "thumbnails" ? '<img src="' + n.slides.eq(c).attr("data-thumb") +
                                '"/>' : "<a>" + i + "</a>";
            ...
            directionNav: {
                setup: function () {
                    var t = e('<ul class="' + o + 'direction-nav"><li><a class="' + o + 'prev" href="#">' + a.prevText +
                        '</a></li><li><a class="' + o + 'next" href="#">' + a.nextText + "</a></li></ul>");
            ...
            pausePlay: {
                ...
                update: function (e) {
                    e === "play" ? n.pausePlay.removeClass(o + "pause").addClass(o + "play").text(a.playText) : n.pausePlay
                        .removeClass(o + "play").addClass(o + "pause").text(a.pauseText)
                }
            },
            touch: function () {
                ...
                function m(r) {
                    if (n.animating) {
                        ...
                        s = l ? n.h : n.w;
                        f = Number(new Date);
                        o = u && c && n.animatingTo === n.last ? 0 : u && c ? n.limit - (n.itemW + a.itemMargin) * n.move *
                            n.animatingTo : u && n.currentSlide === n.last ? n.limit : u ? (n.itemW + a.itemMargin) * n
                            .move * n.currentSlide : c ? (n.last - n.currentSlide + n.cloneOffset) * s : (n.currentSlide +
                            n.cloneOffset) * s;
                ...
                function v(t) {
                    ...
                    p = l ? Math.abs(r) < Math.abs(t.touches[0].pageX - i) : Math.abs(r) < Math.abs(t.touches[0].pageY -
                        i);
                    if (!p || Number(new Date) - f > 500) {
                        t.preventDefault();
                        if (!d && n.transitions) {
                            if (!a.animationLoop) {
                                r = r / (n.currentSlide === 0 && r < 0 || n.currentSlide === n.last && r > 0 ? Math.abs(
                                    r) / s + 2 : 1)
                            }
        ...
        n.flexAnimate = function (t, i, r, m, v) {//切换函数
        ...
        n.canAdvance = function (e, t) {
            ...
            var o = t ? true : f && n.currentItem === n.count - 1 && e === 0 && n.direction === "prev" ? true : f && n.currentItem ===
                0 && e === n.pagingCount - 1 && n.direction !== "next" ? false : e === n.currentSlide && !f ? false : a
                .animationLoop ? true : n.atEnd && n.currentSlide === 0 && e === i && n.direction !== "next" ? false :
                n.atEnd && n.currentSlide === i && e === 0 && n.direction === "next" ? false : true;
            return o
        };
        ...
        n.setProps = function (e, t, i) {
            var o = function () {
                var i = e ? e : (n.itemW + a.itemMargin) * n.move * n.animatingTo,
                    o = function () {
                        if (u) {
                            return t === "setTouch" ? e : c && n.animatingTo === n.last ? 0 : c ? n.limit - (n.itemW +
                                a.itemMargin) * n.move * n.animatingTo : n.animatingTo === n.last ? n.limit : i
                        } else {
                            switch (t) {
                            case "setTotal":
                                return c ? (n.count - 1 - n.currentSlide + n.cloneOffset) * e : (n.currentSlide + n.cloneOffset) *
                                    e;
                            case "setTouch":
                                return c ? e : e;
                            case "jumpEnd":
        ...
        n.setup = function (t) {
            if (!d) {
                ...
                if (a.animationLoop && !u) {
                    ...
                    n.container.append(n.slides.first().clone().addClass("clone")).prepend(n.slides.last().clone().addClass(
                        "clone"))
                }
                ...
                console.log(url);
                var arrtwo=url.split("&");
                var wth = "";
                console.log(arrtwo[1]);
                if(arrtwo[1]==="op=consultation_list"){
                    wth = "";
                }else{
                    wth = "100%";
                }
        ...
        n.doMath = function () {
            ...
            if (u) {
                ...
                n.itemW = n.minW > n.w ? (n.w - t * i) / i : n.maxW < n.w ? (n.w - t * o) / o : a.itemWidth > n.w ? n.w :
                    a.itemWidth;
                n.visible = Math.floor(n.w / (n.itemW + t));
                n.move = a.move > 0 && a.move < n.visible ? a.move : n.visible;
                n.pagingCount = Math.ceil((n.count - n.visible) / n.move + 1);
                n.last = n.pagingCount - 1;
                n.limit = n.pagingCount === 1 ? 0 : a.itemWidth > n.w ? (n.itemW + t * 2) * n.count - n.w - t : (n.itemW +
                    t) * n.count - n.w - t
            } else {
                n.itemW = n.w;
